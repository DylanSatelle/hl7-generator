                    ...
                    @unless(isset($selectedSegments[$segment['code']]))
                        <div class="bg-white rounded-lg shadow-md relative overflow-visible">
                            ...
                            <div class="p-4 flex flex-col gap-2">
                                ...
                                <p class="text-gray-700">{{ $segment['title'] }}</p>
                                <p class="text-gray-500 text-sm">{{ $segment['description'] }}</p>
                            </div>
                        </div>
                    @endunless
                @endforeach
                ...
                @if($hl7Message || $fakeMessage)
                    <div class="relative bg-white rounded-lg shadow-md mt-4 p-4">
                        <button wire:click="downloadHL7"
                            class="bg-green-500 text-white px-6 py-2 rounded hover:bg-green-600 mb-2">
                            Save
                        </button>
                        ...
                        @foreach($selected['fields'] as $field)
                            <div class="flex flex-col mb-2">
                                ...
                                <input type="text"
                                       ...
                                       class="border rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-400 w-full">
                            </div>
                        @endforeach
